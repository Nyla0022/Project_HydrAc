 ...
 */
static char s_vPrintfStringBuffer[64];
 ...
 */
mcapi_status_t startPrintfService(
		mcapi_port_t port
	)
{
	return StartService(s_vPrintfStringBuffer,
						sizeof(s_vPrintfStringBuffer),
						port,
						&doPrintfService,
						STDOUT_SERVICE);
}
