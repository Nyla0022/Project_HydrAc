...
#ifndef THREECORE_CORE2_H
#define THREECORE_CORE2_H
...
/* Prototypes for functions defined in Communications_Core2.c */
...
/* Prototypes for functions defined in ThreeCore_Core2.c */
