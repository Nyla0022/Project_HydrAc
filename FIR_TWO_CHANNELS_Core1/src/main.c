...
int main()
{
	...
	*pREG_SEC0_CCTL1=ENUM_SEC_CCTL1_EN;
	...
	FIRA_Init(BITM_FIR_CTL1_EN|BITM_FIR_CTL1_DMAEN|BITM_FIR_CTL1_CCINTR|(CHANNEL_NO-1)<<BITP_FIR_CTL1_CH,(uint32_t*)(((int)(FIRA_TCB1+12)>>2)|0xA000000));
