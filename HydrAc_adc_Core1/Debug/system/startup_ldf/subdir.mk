...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="HydrAc_adc_Core1" -proc ADSP-SC584 -si-revision 1.0 -g -DCORE1 -D_DEBUG @includes-20312ff1b8f70e2f448068ed2bee1216.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="HydrAc_adc_Core1" -proc ADSP-SC584 -si-revision 1.0 -g -DCORE1 -D_DEBUG @includes-20312ff1b8f70e2f448068ed2bee1216.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
