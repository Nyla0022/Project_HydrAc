...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="HydrAc_adc_Core2" -proc ADSP-SC584 -si-revision 1.0 -g -DCORE2 -D_DEBUG @includes-b80184ce086f69b8e517795afa012043.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="HydrAc_adc_Core2" -proc ADSP-SC584 -si-revision 1.0 -g -DCORE2 -D_DEBUG @includes-b80184ce086f69b8e517795afa012043.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
